...
- `python3 create_drive_dataroom.py --dry-run --target-dir /tmp/cdc-dataroom-automation-test`
- `python3 create_drive_dataroom.py --target-dir /tmp/cdc-dataroom-automation-test --report-file /tmp/cdc-dataroom-automation-test/report.json`
